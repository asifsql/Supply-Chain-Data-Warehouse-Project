...
SELECT s.invoiceid, MIN(s.orderdate) AS orderdate, s.sku, MAX(st.storename) AS storename,
...
SELECT i.snapshotdate, st.storename, i.sku, 
...
GROUP BY i.snapshotdate, st.storename, i.sku;
...
SELECT po.po_id, po.orderdate, po.sku, sup.suppliername,
...
GROUP BY po.po_id, po.orderdate, po.sku, sup.suppliername;
